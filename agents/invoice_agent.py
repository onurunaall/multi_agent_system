"""
Invoice information sub-agent implementation.
Uses LangGraph pre-built ReAct agent for rapid development.
"""
...
You are the invoice-information specialist.  
Only respond to invoice-related queries.
